...
*CaffeineAddict is a software i wrote as a hobby to not make the computer sleep, especially for long hours of compilation or download. it keeps moving the cursor to various positions to keep the system awake.*
...
- [PEDS_USPTO](https://github.com/vedaprakashms/PEDS_USPTO/releases/download/V1.0/PEDS_Portable_app-win32-ia32.7z)
...
- [installation instructions](/about/)
